...
<head>
  ...
  <!-- <link href="/css/style-selectbox.css" rel="stylesheet" type="text/css"> -->
               ...
               <div class="col-content">
                    ...
                    <section id="catalog-list" class="short">
                        ...
                        <div class="control">
                            ...
                            <div class="type">
                                ...
                                <a class="ico-type-plitka selected" href="#"></a>
                            </div>
                        </div>
                        <div class="items">
                            <div class="item">
                                ...
                                <div class="img">
                                    ...
                                    <span class="action ico-action-finger orange-icon warning-orange has-popup">
                                            ...
                                            <div style="width: 185px;" class="content center popup-text">
                                                ...
                                                <table class="pp-table">
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <p class="pp-desc">
                                                                <span class="pp-orage">Акция</span> - товар участвует в персональной ации (1шт)
                                                                <a href="#">>></a>
                                                            </p>
                                                        </td>
                                                    </tr>
                                                ...
                                                <button style="margin-top: 10px;" class="btn-buy">Купить</button>
                                ...
                                <div class="rating">
                                    ...
                                    <span class="notinstock">нет наличии</span>
                                </div>
                                <div class="price">
                            ...
                            <div class="item">
                                ...
                                <div class="img">
                                    ...
                                    <span class="action orange-icon coins-orange has-popup">
                                        <i></i>
                                        <div class="popup center ">
                                            <div class="content center popup-text">
                                                <div class="pp-title">ВЫГОДНАЯ ЦЕНА!</div>
                                                <p class="pp-desc">
                                                    выгодная покупка
                                                </p>
                                            </div>
                    ...
                    <section id="articles">
                        <div class="items">
                            <article class="item">
                                <a class="img" href="#">
                                    <img src="/img/images/catalog-plitka/articles1.jpg" alt=""/>
                                    <div class="hover"></div>
                                </a>
                           ...
                           <article class="item">
                                <a class="img" href="#">
                                    <img src="/img/images/catalog-plitka/articles2.jpg" alt=""/>
                                    <div class="hover"></div>
                                </a>
                            ...
                            <article class="item">
                                <a class="img" href="#">
                                    <img src="/img/images/catalog-plitka/articles3.jpg" alt=""/>
                                    <div class="hover"></div>
                                </a>
                                <div class="right">
            ...
            <section class="col-left">
                ...
                <div id="catalog-filter">
                 <form action="">
                    ...
                    <div class="item gray slider cb">
                        <div class="title">Цена</div>
                        <a id="clear1" class="clear" style="display: none;">сбросить</a>
                    ...
                    <div class="item gray slider bally cb">
                        <div class="title">Цена по баллам</div>
                        <a id="clear2" class="clear" style="display: none;">сбросить</a>
                ...
                <a class="banner" href="#">
                    <img src="/img/images/catalog-plitka/banner1.jpg" alt=""/>
                </a>
            </section>
            <!--(/левая колонка)-->
            <div class="clear"></div>
