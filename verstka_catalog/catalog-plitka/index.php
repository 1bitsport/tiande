            ...
            <section class="col-right">
               <div class="col-content">
                    ...
                    <section id="catalog-list" class="short">
                        ...
                        <div class="items">
                            <div class="item">
                                <a href="/card.php" class="name">
                                    Шампунь Шампунь Шампунь Шампунь Шампунь
                                </a>
                                <div class="img">
                                    <a href="/card.php" onclick="">
                                        <img src="/temp/item-1.jpg" alt=""/>
                                        <s class="modal-viewer" data-key="#fast-buy">БЫСТРЫЙ ПРОСМОТР</s>
                                    </a>
                ...
                <nav id="menu_catalog">
                    <ul>
                        <li class="root-item selected has-child"><a href="#">СПЕЦИАЛЬНЫЕ СРЕДСТВА И МАССАЖЕРЫ (20)</a>
                            <ul>
                                <li class="child selected"><a href="#">Очищение с водой (2)</a></li>
