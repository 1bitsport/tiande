...
<head>
  ...
  <noscript>
    <style>
    .no-js .has-popup:hover .popup,  .no-js .has-popup:hover > i { display: block }
    .no-js .swiper-container .swiper-slides[data-group='1'] { display: block; }
    .no-js .products .tabs a:first-child { color: #000; border-bottom: 1px solid #000; }
...
<body>
  ...
  <nav id="top-submenu">
    ...
    <div class="right">
      ...
      <div class="has-popup has-icon ref">
        ...
        <div class="popup center" id="partnership">
          <div class="content">
            ...
            <hr>
            <div class="social">
              <a href="#1" id="share">Поделиться</a>
      ...
      <div class="has-popup has-icon open-arrow" id="sign-in">
        <a href="#1" class="border-dotted has-modal" data-id="sign-in"><img src="/img/user.png"/>ВХОД</a>
        <s></s><i></i>
  ...
  <div class="container main-container">
          ...
          <div class="popup">
            <div class="content">
              ...
              <td>
                ...
                <a href="#1">Ukraine</a>
                <a href="#1">Poland</a>
                <a href="#1" class="active">Russia</a>
                <a href="#1">Armenia</a>
    ...
    <main >
        <section id="two-cols">
            ...
            <section class="col-right">
               <div class="col-content">
                    ...
                    <nav id="breadcrumb" itemprop="breadcrumb">
                        <ul>
                            <li class="item"><a href="#">для волос</a></li>
                            <li class="item"><a href="#">очищение и тонизирование</a></li>
                            <li class="item last">очищение с водой</li>
                        </ul>
                    </nav>
                    <!--(/хлебные крошки)-->
                    ...
                    <section id="catalog-list" class="short">
                        <h1 class="title"> ОЧИЩЕНИЕ С водой</h1>
                        <div class="control">
                            <div class="sort">
                              <form action="">
                                <span class="title">
                                ...
                                <div class="sorter">
                                    <input type="text" disabled value="Рейтингу" class="input-sort drop" name="sort" id="the-sort">
                                ...
                                <select name="ww" id="ww" class="styled nojs-sort">
                                    <option value="0">Ретингу</option>
                                    <option value="1">Цены по убыванию</option>
                                    <option value="1">Цены по возрастанию</option>
                            ...
                            <div class="type">
                                ...
                                <a class="ico-type-short-list" href="#"></a>
                                <a class="ico-type-list selected" href="#"></a>
                                <a class="ico-type-plitka" href="#"></a>
                            </div>
                        </div>
                        ...
                        <table class="t-items">
                            <tr class="t-item">
                                ...
                                <td class="left">
                                    ...
                                    <div class="desc">
                                        (против седины, для всех типов волос)
                                    </div>
                                    <div class="empt"></div>
                                    <div class="desc bottom">Код: 3243 &nbsp;&nbsp;&nbsp;&nbsp; Объем 250 мл</div>
                                </td>
                                <td class="center">
                                    <div class="up">
                                        <ul class="action">
                                            <li class="has-popup orange-icon warning-orange">
                                                <!-- <img src="/img/ico/catalog-list/ico-action-1.jpg" alt=""> -->
                                                <i></i>

                                                <div class="popup center">
                                                    <div class="content center popup-text">
                                                        <div class="pp-title">АКЦИЯ!</div>
                                                        <p class="pp-desc">
                                                            <a class="pp-link" href="#">товар участвует в акции по каталогу (3шт.)</a>
                                                            &gt;&gt;
                                                        </p>
                                                    </div>
                                                </div>
                                            </li>
                                            <li class="has-popup orange-icon present-orange">
                                            ...
                                            <li class="has-popup orange-icon new-orange">
                                                <!-- <img src="/img/ico/catalog-list/ico-action-3.jpg" alt=""> -->
                                                <i></i>
                                            ...
                                            <li class="has-popup orange-icon percent-orange">
                                                <!-- <img src="/img/ico/catalog-list/ico-action-4.jpg" alt=""> -->
                                                <i></i>
                                    ...
                                    <div class="down ton">
                                        <div class="prop">
                                            ...
                                            <ul class="color">
                                                <li>
                                                    <label>
                                                        <input type="radio" checked class="not-styler beyond" data-pic="/temp/item-1.jpg" name="tons11">
                                                        <img width="20" height="20" src="/img/tons/ton-1.jpg" alt=""/>
                                                    </label>
                                                    <span class="hint"> 003 </span>
                                                </li>
                                                <li>
                                                    <label>
                                                        <input type="radio" class="not-styler beyond" data-pic="/temp/item-3.jpg" name="tons11">
                                                        <img width="20" height="20" src="/img/tons/ton-2.jpg" alt=""/>
                                                    </label>
                                                    <span class="hint"> 022 </span>
                                                </li>
                                                <li>
                                                    <label>
                                                        <input type="radio" class="not-styler beyond" data-pic="/temp/item-4.jpg" name="tons11">
                                                        <img width="20" height="20" src="/img/tons/ton-3.jpg" alt=""/>
                                                    </label>
                                                    <span class="hint"> 007 </span>
                                                </li>
                                                <li>
                                                    <label>
                                                        <input type="radio" class="not-styler beyond" data-pic="/temp/item-2.jpg" name="tons11">
                                                        <img width="20" height="20" src="/img/tons/ton-4.jpg" alt=""/>
                                                    </label>
                                                    <span class="hint"> 005 </span>
                                                </li>
                                                <li>
                                                    <label>
                                                        <input type="radio" class="not-styler beyond" data-pic="/temp/item-5.jpg" name="tons11">
                                                        <img width="20" height="20" src="/img/tons/ton-5.jpg" alt=""/>
                                                    </label>
                                                    <span class="hint"> 005 </span>
                                                </li>
                                            </ul>
                                                ...
                                                <div class="popup right">
                                                    <div class="content">
                                                        <ul class="color">
                                                            ...
                                                            <li>
                                                                <label>
                                                                  <input type="radio" class="not-styler beyond" data-pic="/temp/item-7.jpg" name="tons11">
                                                                  <img width="20" height="20" src="/img/tons/ton-4.jpg" alt=""/>
                                                                </label>
                                                                <span class="hint"> 005 </span>
                                                            </li>
                                                            ...
                                                            <li>
                                                                <label>
                                                                  <input type="radio" class="not-styler beyond" data-pic="/temp/item-2.jpg" name="tons11">
                                                                  <img width="20" height="20" src="/img/tons/ton-6.jpg" alt=""/>
                                                                </label>
                                                                <span class="hint"> 003 </span>
                                                            </li>
                                                            <li>
                                                                <label>
                                                                  <input type="radio" class="not-styler beyond" data-pic="/temp/item-2.jpg" name="tons11">
                                                                  <img width="20" height="20" src="/img/tons/ton-7.jpg" alt=""/>
                                                                </label>
                                                                <span class="hint"> 022 </span>
                                                            </li>
                                                            <li>
                                                                <label>
                                                                  <input type="radio" class="not-styler beyond" data-pic="/temp/item-2.jpg" name="tons11">
                                                                  <img width="20" height="20" src="/img/tons/ton-8.jpg" alt=""/>
                                                                </label>
                                                                <span class="hint"> 007 </span>
                                                            </li>
                                                            <li>
                                                                <label>
                                                                  <input type="radio" class="not-styler beyond" data-pic="/temp/item-2.jpg" name="tons11">
                                                                  <img width="20" height="20" src="/img/tons/ton-9.jpg" alt=""/>
                                                                </label>
                                                                <span class="hint"> 005 </span>
                                                            </li>
                                                            <li>
                                                                <label>
                                                                  <input type="radio" class="not-styler beyond" data-pic="/temp/item-2.jpg" name="tons11">
                                                                  <img width="20" height="20" src="/img/tons/ton-10.jpg" alt=""/>
                                                                </label>
                                                                <span class="hint"> 005 </span>
                                                            </li>
                                                            <li>
                                                                <label>
                                                                  <input type="radio" class="not-styler beyond" data-pic="/temp/item-2.jpg" name="tons11">
                                                                  <img width="20" height="20" src="/img/tons/ton-11.jpg" alt=""/>
                                                                </label>
                                                                <span class="hint"> 003 </span>
                                                            </li>
                                                            <li>
                                                                <label>
                                                                  <input type="radio" class="not-styler beyond" data-pic="/temp/item-2.jpg" name="tons11">
                                                                  <img width="20" height="20" src="/img/tons/ton-12.jpg" alt=""/>
                                                                </label>
                                                                <span class="hint"> 022 </span>
                                                            </li>
                                                            <li>
                                                                <label>
                                                                  <input type="radio" class="not-styler beyond" data-pic="/temp/item-2.jpg" name="tons11">
                                                                  <img width="20" height="20" src="/img/tons/ton-13.jpg" alt=""/>
                                                                </label>
                                                                <span class="hint"> 007 </span>
                                                            </li>
                                                            <li>
                                                                <label>
                                                                  <input type="radio" class="not-styler beyond" data-pic="/temp/item-2.jpg" name="tons11">
                                                                  <img width="20" height="20" src="/img/tons/ton-14.jpg" alt=""/>
                                                                </label>
                                                                <span class="hint"> 005 </span>
                                                            </li>
                                                            <li>
                                                                <label>
                                                                  <input type="radio" class="not-styler beyond" data-pic="/temp/item-2.jpg" name="tons11">
                                                                  <img width="20" height="20" src="/img/tons/ton-15.jpg" alt=""/>
                                                                </label>
                                                                <span class="hint"> 005 </span>
                                                            </li>
                                                            <li>
                                                                <label>
                                                                  <input type="radio" class="not-styler beyond" data-pic="/temp/item-2.jpg" name="tons11">
                                                                  <img width="20" height="20" src="/img/tons/ton-16.jpg" alt=""/>
                                                                </label>
                                                                <span class="hint"> 003 </span>
                                                            </li>
                                                            <li>
                                                                <label>
                                                                  <input type="radio" class="not-styler beyond" data-pic="/temp/item-2.jpg" name="tons11">
                                                                  <img width="20" height="20" src="/img/tons/ton-17.jpg" alt=""/>
                                                                </label>
                                                                <span class="hint"> 022 </span>
                                                            </li>
                                                            <li>
                                                                <label>
                                                                  <input type="radio" class="not-styler beyond" data-pic="/temp/item-2.jpg" name="tons11">
                                                                  <img width="20" height="20" src="/img/tons/ton-18.jpg" alt=""/>
                                                                </label>
                                                                <span class="hint"> 007 </span>
                                                            </li>
                                                            <li>
                                                                <label>
                                                                  <input type="radio" class="not-styler beyond" data-pic="/temp/item-2.jpg" name="tons11">
                                                                  <img width="20" height="20" src="/img/tons/ton-19.jpg" alt=""/>
                                                                </label>
                                                                <span class="hint"> 005 </span>
                                                            </li>
                                                            <li>
                                                                <label>
                                                                  <input type="radio" class="not-styler beyond" data-pic="/temp/item-2.jpg" name="tons11">
                                                                  <img width="20" height="20" src="/img/tons/ton-20.jpg" alt=""/>
                                                                </label>
                                                                <span class="hint"> 005 </span>
                                                            </li>
                                ...
                                <td class="info">
                                  <div class="floater">
                                    ...
                                    <div class="price">
                                        <span class="oldprice">3 007 руб.</span>
                                        <br>
                                        <span class="price">2 700 руб.</span>

                                         <div class="ask has-popup hover">
                                        <span class="instead-what-img">?</span>
                                            <i></i>

                                            <div class="popup center">
                                                <div style="width: 210px;" class="content center popup-text">
                                                    <a href="#" class="pp-title"><span class="sale">СЕРВИС "МОЯ СКИДКА"!</span></a>
                                                    <p class="pp-desc">
                                                        <span class="pp-orage">10% (ваша скидка)</span> - скидка, при покупке сумарного количества баллов от 20б до 50б (Не включая 50Б)
                                                    </p>
                                                    <p class="pp-desc">
                                                        <span class="pp-orage">15%</span> - скидка, при покупке сумарного количества баллов от 50б до 100б (Не включая 100Б)
                                                    </p>
                                                    <p class="pp-desc">
                                                        <span class="pp-orage">20%</span> - скидка, при покупке сумарного количества баллов от 100б до 500б (Не включая 500Б)
                                                    </p>
                                                    <p class="pp-desc">
                                                        <span class="pp-orage">25%</span> - скидка, при покупке сумарного количества баллов от 500б, а так же для участника Партнёрской программы
                                                    </p>
                                    ...
                                    <div class="bally">20 Б</div>
                                  </div>
                                </td>
                                <td class="action empty">
                                    <div class="instock">в наличии</div>
                                    <div class="notinstock">нет наличии</div>
                                    <br>
                                    <button class="btn-buy">Купить</button>
                                    <br>
                                    <a class="todetail" href="#">подробнее ></a>
                                </td>
                            </tr>
                            <tr class="t-item">
                            <td class="img">
                            ...
                            <td class="center">
                                ...
                                <div class="down ton">
                                    <div class="prop">
                                            <span class="title" style="position: relative; top:auto; bottom: -4px;">
                                                Размер:
                                            </span>
                                        <ul class="size">
                                            <li>
                                              <label>
                                                  <input type="radio" checked class="not-styler beyond" name="tons20">
                                                  <i> 20 </i>
                                              </label>
                                            </li>
                                            <li>
                                              <label>
                                                  <input type="radio" class="not-styler beyond" name="tons20">
                                                  <i> 24 </i>
                                              </label>
                                            </li>
                                            <li>
                                ...
                                <div class="price">
                                    ...
                                    <span class="price">2 700 руб.</span>
                                     ...
                                     <div class="ask has-popup hover">
                                        ...
                                        <div class="popup center">
                                            <div style="width: 210px;" class="content center popup-text">
                                                <h2 class="pp-title"><span class="sale">СЕРВИС "МОЯ СКИДКА"!</span></h2>
                                                <p class="pp-desc">
                                                    <span class="pp-orage">10% (ваша скидка)</span> - скидка, при покупке сумарного количества баллов от 20б до 50б (Не включая 50Б)
                                                </p>
                                                <p class="pp-desc">
                            ...
                            <tr class="t-item">
                                ...
                                <td class="center">
                                    <div class="up">
                                        <ul class="action">
                                            <li class="has-popup orange-icon star-orange">
                                                <!-- <img src="/img/ico/catalog-list/ico-action-1.jpg" alt=""> -->
                                                <i></i>
                                            ...
                                            <li class="has-popup orange-icon finger-orange">
                                                <!-- <img src="/img/ico/catalog-list/present.png" alt=""> -->
                                                <i></i>
                                            ...
                                            <li class="has-popup orange-icon love-orange">
                                                <!-- <img src="/img/ico/catalog-list/ico-action-3.jpg" alt=""> -->
                                                <i></i>
                                            ...
                                            <li class="has-popup orange-icon bottles-orange">
                                                <!-- <img src="/img/ico/catalog-list/ico-action-4.jpg" alt=""> -->
                                                <i></i>
                                    ...
                                    <div class="down ton">
                                        <div class="prop">
                                            ...
                                            <ul class="color">
                                                <li>
                                                    <label>
                                                        <input type="radio" checked class="not-styler beyond" data-pic="/temp/item-1.jpg" name="tons12">
                                                        <img width="20" height="20" src="/img/tons/ton-1.jpg" alt=""/>
                                                    </label>
                                                    <span class="hint"> 003 </span>
                                                </li>
                                                <li>
                                                    <label>
                                                        <input type="radio" class="not-styler beyond" data-pic="/temp/item-2.jpg" name="tons12">
                                                        <img width="20" height="20" src="/img/tons/ton-2.jpg" alt=""/>
                                                    </label>
                                                    <span class="hint"> 022 </span>
                                                </li>
                                                <li>
                                                    <label>
                                                        <input type="radio" class="not-styler beyond" data-pic="/temp/item-3.jpg" name="tons12">
                                                        <img width="20" height="20" src="/img/tons/ton-3.jpg" alt=""/>
                                                    </label>
                                                    <span class="hint"> 007 </span>
                                                </li>
                                                <li>
                                                    <label>
                                                        <input type="radio" class="not-styler beyond" data-pic="/temp/item-4.jpg" name="tons12">
                                                        <img width="20" height="20" src="/img/tons/ton-4.jpg" alt=""/>
                                                    </label>
                                                    <span class="hint"> 005 </span>
                                                </li>
                                                ...
                                                <div class="popup right">
                                                    <div class="content">
                                                        <ul class="color">
                                                            <li>
                                                                <label>
                                                                  <input type="radio" class="not-styler beyond" data-pic="/temp/item-7.jpg" name="tons12">
                                                                  <img width="20" height="20" src="/img/tons/ton-1.jpg" alt=""/>
                                                                </label>
                                                                <span class="hint"> 003 </span>
                                                            </li>
                                                            <li>
                                                                <label>
                                                                  <input type="radio" class="not-styler beyond" data-pic="/temp/item-6.jpg" name="tons12">
                                                                  <img width="20" height="20" src="/img/tons/ton-2.jpg" alt=""/>
                                                                </label>
                                                                <span class="hint"> 022 </span>
                                                            </li>
                                                            ...
                                                            <li>
                                                                <label>
                                                                  <input type="radio" class="not-styler beyond" data-pic="/temp/item-8.jpg" name="tons12">
                                                                  <img width="20" height="20" src="/img/tons/ton-4.jpg" alt=""/>
                                                                </label>
                                                                <span class="hint"> 005 </span>
                                                            </li>
                                                            ...
                                                            <li>
                                                                <label>
                                                                  <input type="radio" class="not-styler beyond" data-pic="/temp/item-10.jpg" name="tons12">
                                                                  <img width="20" height="20" src="/img/tons/ton-6.jpg" alt=""/>
                                                                </label>
                                                                <span class="hint"> 003 </span>
                                                            </li>
                                                            <li>
                                                                <label>
                                                                  <input type="radio" class="not-styler beyond" data-pic="/temp/item-9.jpg" name="tons12">
                                                                  <img width="20" height="20" src="/img/tons/ton-7.jpg" alt=""/>
                                                                </label>
                                                                <span class="hint"> 022 </span>
                                                            </li>
                                                            ...
                                                            <li>
                                                                <label>
                                                                  <input type="radio" class="not-styler beyond" data-pic="/temp/item-11.jpg" name="tons12">
                                                                  <img width="20" height="20" src="/img/tons/ton-10.jpg" alt=""/>
                                                                </label>
                                                                <span class="hint"> 005 </span>
                                                            </li>
                            ...
                            <tr class="t-item">
                                ...
                                <td class="center">
                                    <div class="up">
                                        <ul class="action">
                                            <li class="has-popup orange-icon coins-orange">
                                                <!-- <img src="/img/ico/catalog-list/ico-action-1.jpg" alt=""> -->
                                                <i></i>
                                    ...
                                    <div class="down ton">
                                        <div class="prop">
                                            ...
                                            <ul class="color">
                                                <li>
                                                    <label>
                                                        <input type="radio" checked class="not-styler beyond" data-pic="/temp/item-1.jpg" name="tons13">
                                                        <img width="20" height="20" src="/img/tons/ton-1.jpg" alt=""/>
                                                    </label>
                                                    <span class="hint"> 003 </span>
                                                </li>
                                                <li>
                                                    <label>
                                                        <input type="radio" class="not-styler beyond" data-pic="/temp/item-2.jpg" name="tons13">
                                                        <img width="20" height="20" src="/img/tons/ton-2.jpg" alt=""/>
                                                    </label>
                                                    <span class="hint"> 022 </span>
                                                </li>
                                                <li>
                                                    <label>
                                                        <input type="radio" class="not-styler beyond" data-pic="/temp/item-3.jpg" name="tons13">
                                                        <img width="20" height="20" src="/img/tons/ton-3.jpg" alt=""/>
                                                    </label>
                                                    <span class="hint"> 007 </span>
                                                </li>
                                                <li>
                                                    <label>
                                                        <input type="radio" class="not-styler beyond" data-pic="/temp/item-4.jpg" name="tons13">
                                                        <img width="20" height="20" src="/img/tons/ton-4.jpg" alt=""/>
                                                    </label>
                                                    <span class="hint"> 005 </span>
                                                </li>
                                                <li>
                                                    <label>
                                                        <input type="radio" class="not-styler beyond" data-pic="/temp/item-8.jpg" name="tons13">
                                                        <img width="20" height="20" src="/img/tons/ton-5.jpg" alt=""/>
                                                    </label>
                                                    <span class="hint"> 005 </span>
                                                </li>
                                                ...
                                                <div class="popup right">
                                                    <div class="content">
                                                        <ul class="color">
                                                            ...
                                                            <li>
                                                                <label>
                                                                  <input type="radio" class="not-styler beyond" data-pic="/temp/item-9.jpg" name="tons13">
                                                                  <img width="20" height="20" src="/img/tons/ton-4.jpg" alt=""/>
                                                                </label>
                                                                <span class="hint"> 005 </span>
                                                            </li>
                                    ...
                                    <div class="down ton">
                                        <div class="prop">
                                            ...
                                            <ul class="color">
                                                <li>
                                                    <label>
                                                        <input type="radio" checked class="not-styler beyond" data-pic="/temp/item-1.jpg" name="tons14">
                                                        <img width="20" height="20" src="/img/tons/ton-1.jpg" alt=""/>
                                                    </label>
                                                    <span class="hint"> 003 </span>
                                                </li>
                                                <li>
                                                    <label>
                                                        <input type="radio" class="not-styler beyond" data-pic="/temp/item-2.jpg" name="tons14">
                                                        <img width="20" height="20" src="/img/tons/ton-2.jpg" alt=""/>
                                                    </label>
                                                    <span class="hint"> 022 </span>
                                                </li>
                                                <li>
                                                    <label>
                                                        <input type="radio" class="not-styler beyond" data-pic="/temp/item-3.jpg" name="tons14">
                                                        <img width="20" height="20" src="/img/tons/ton-3.jpg" alt=""/>
                                                    </label>
                                                    <span class="hint"> 007 </span>
                                                </li>
                                                <li>
                                                    <label>
                                                        <input type="radio" class="not-styler beyond" data-pic="/temp/item-4.jpg" name="tons14">
                                                        <img width="20" height="20" src="/img/tons/ton-4.jpg" alt=""/>
                                                    </label>
                                                    <span class="hint"> 005 </span>
                                                </li>
                                                <li>
                                                    <label>
                                                        <input type="radio" class="not-styler beyond" data-pic="/temp/item-5.jpg" name="tons14">
                                                        <img width="20" height="20" src="/img/tons/ton-5.jpg" alt=""/>
                                                    </label>
                                                    <span class="hint"> 005 </span>
                                                </li>
                                                ...
                                                <div class="popup right">
                                                    <div class="content">
                                                        <ul class="color">
                                                            <li>
                                                                <label>
                                                                  <input type="radio" class="not-styler beyond" data-pic="/temp/item-1.jpg" name="tons14">
                                                                  <img width="20" height="20" src="/img/tons/ton-1.jpg" alt=""/>
                                                                </label>
                                                                <span class="hint"> 003 </span>
                                                            </li>
                                                            ...
                                                            <li>
                                                                <label>
                                                                  <input type="radio" class="not-styler beyond" data-pic="/temp/item-6.jpg" name="tons14">
                                                                  <img width="20" height="20" src="/img/tons/ton-9.jpg" alt=""/>
                                                                </label>
                                                                <span class="hint"> 005 </span>
                                                            </li>
                                                            ...
                                                            <li>
                                                                <label>
                                                                  <input type="radio" class="not-styler beyond" data-pic="/temp/item-11.jpg" name="tons14">
                                                                  <img width="20" height="20" src="/img/tons/ton-20.jpg" alt=""/>
                                                                </label>
                                                                <span class="hint"> 005 </span>
                                                            </li>
                                    ...
                                    <div class="down ton">
                                        <div class="prop">
                                            ...
                                            <ul class="color">
                                                <li>
                                                    <label>
                                                        <input type="radio" checked class="not-styler beyond" data-pic="/temp/item-1.jpg" name="tons15">
                                                        <img width="20" height="20" src="/img/tons/ton-1.jpg" alt=""/>
                                                    </label>
                                                    <span class="hint"> 003 </span>
                                                </li>
                                                <li>
                                                    <label>
                                                        <input type="radio" class="not-styler beyond" data-pic="/temp/item-2.jpg" name="tons15">
                                                        <img width="20" height="20" src="/img/tons/ton-2.jpg" alt=""/>
                                                    </label>
                                                    <span class="hint"> 022 </span>
                                                </li>
                                                <li>
                                                    <label>
                                                        <input type="radio" class="not-styler beyond" data-pic="/temp/item-3.jpg" name="tons15">
                                                        <img width="20" height="20" src="/img/tons/ton-3.jpg" alt=""/>
                                                    </label>
                                                    <span class="hint"> 007 </span>
                                                </li>
                                                <li>
                                                    <label>
                                                        <input type="radio" class="not-styler beyond" data-pic="/temp/item-4.jpg" name="tons15">
                                                        <img width="20" height="20" src="/img/tons/ton-4.jpg" alt=""/>
                                                    </label>
                                                    <span class="hint"> 005 </span>
                                                </li>
                                                <li>
                                                    <label>
                                                        <input type="radio" class="not-styler beyond" data-pic="/temp/item-5.jpg" name="tons15">
                                                        <img width="20" height="20" src="/img/tons/ton-5.jpg" alt=""/>
                                                    </label>
                                                    <span class="hint"> 005 </span>
                                                </li>
                                                ...
                                                <div class="popup right">
                                                    <div class="content">
                                                        <ul class="color">
                                                            <li>
                                                                <label>
                                                                  <input type="radio" class="not-styler beyond" data-pic="/temp/item-7.jpg" name="tons15">
                                                                  <img width="20" height="20" src="/img/tons/ton-1.jpg" alt=""/>
                                                                </label>
                                                                <span class="hint"> 003 </span>
                                                            </li>
                                                            <li>
                                                                <label>
                                                                  <input type="radio" class="not-styler beyond" data-pic="/temp/item-9.jpg" name="tons15">
                                                                  <img width="20" height="20" src="/img/tons/ton-2.jpg" alt=""/>
                                                                </label>
                                                                <span class="hint"> 022 </span>
                                                            </li>
                                                            ...
                                                            <li>
                                                                <label>
                                                                  <input type="radio" class="not-styler beyond" data-pic="/temp/item-10.jpg" name="tons15">
                                                                  <img width="20" height="20" src="/img/tons/ton-5.jpg" alt=""/>
                                                                </label>
                                                                <span class="hint"> 005 </span>
                                                            </li>
                        ...
                        <div class="centerinnerblock">
                            <div class="navigation">
                                ...
                                <ul>
                                    <li><a href="">1</a></li>
                                    <li><a href="">...</a></li>
                                    <li class="selected"><a href="">97</a></li>
                                    <li><a href="">98</a></li>
                                    <li class="last"><a href="">99</a></li>
                                </ul>
                                <a href="#" class="next">▶</a>
                            </div>
                        </div>
                    ...
                    <section id="articles">
                        <div class="items">
                            <article class="item">
                                <a class="img" href="#">
                                    <img src="/img/images/catalog-list/articles1.jpg" alt=""/>
                                    <div class="hover"></div>
                                </a>

                                <div class="right">
                                    <h2 class="name">GOLD GINGER</h2>
                                    <a href="#" class="name2">МЕЧТАЕТЕ ИМЕТЬ ДЛИННЫЕ ВОЛОСЫ?</a>
                                    <p class="desc">
                                        Волосы — источник нашей космической силы, значит, все, что с ними происходит, меняет русло незримой реки, которая омывает нас своими биоэнергетическими волнами. Чем крепче и длиннее волос — тем больше энергии человек получает извне. Но отрастить длинные волосы бывает крайне нелегко, на это уходят годы.
                                    </p>
                                    <a href="#" class="todetail">читать далее...</a>
                                </div>
                                <div class="clear"></div>
                            </article>
                            <article class="item">
                                <a class="img" href="#">
                                    <img src="/img/images/catalog-list/articles2.jpg" alt=""/>
                                    <div class="hover"></div>
                                </a>

                                <div class="right">
                                    <h2 class="name">BIO REHAB</h2>
                                    <a href="#" class="name2">ТЕРЯЕТЕ БОЛЬШЕ 50-100 ВОЛОСКОВ В ДЕНЬ? БЕЗ ПАНИКИ!</a>
                                    <p class="desc">
                                        Средства TianDe решат проблему в корне!
                                        Нормой считается выпадение от 50 до 100 волосков в день. Выпадение волос – то, с чем борются миллионы мужчин и женщин во всем мире. По статистике, от облысения страдает 60–70% мужчин и 25–40% женщин. Потеря  большего количества  волос может иметь разные причины. Одной из самых распространенных причин облысения является избыточное образование мужских гормонов...
                                    </p>
                                    <a href="#" class="todetail">читать далее...</a>
                                </div>
                                <div class="clear"></div>
                            ...
                            <article class="item">
                                <a class="img" href="#">
                                    <img src="/img/images/catalog-list/articles3.jpg" alt=""/>
                                    <div class="hover"></div>
                                </a>
                                <div class="right">
                                    <a href="#" class="name">СОЛНЕЧНЫЕ ОЛИВКИ</a>
                                    <p class="desc">
                                        Шампунь «Солнечные оливки» мягко очищает и восстанавливает структуру волос. Стимулирует их сопротивляемость внешним воздействиям. Придает волосам здоровый вид и природный блеск. Это шампунь для витализации (от лат Vita — «жизнь») – придания волосам жизненных сил.
                                        В основе формулы шампуня «Солнечные оливки» лежит масло, получаемое из...
                                    </p>
                                    <a href="#" class="todetail">читать далее...</a>
                                </div>
                                <div class="clear"></div>
            ...
            <section class="col-left">
                ...
                <nav id="menu_catalog">
                    <ul>
                        <li class="root-item selected has-child"><a href="#">СПЕЦИАЛЬНЫЕ СРЕДСТВА И МАССАЖЕРЫ (20)</a>
                            <ul>
                                <li><a href="#">Очищение с водой (2)</a></li>
                                <li><a href="#">Тонизирующие средства (3)</a></li>
                                <li><a href="#">Аксессуары для умывания (6)</a></li>
                                <li><a href="#">Матирующие салфетки (8)</a></li>
                                <li><a href="#">Очищающие пластыри для носа (1)</a></li>
                                <li class="has-child">
                                    <a href="#">3 уровень</a>
                                    <ul>
                                        <li class="item-selected"><a href="#">Очищение с водой (2)</a></li>
                                        <li><a href="#">Тонизирующие средства (3)</a></li>
                                    </ul>
                                </li>
                            </ul></li>
                        <li class="root-item has-child"><a href="#">БАЛЬЗАМЫ (9)</a>
                            <ul>
                                <li><a href="#">Матирующие салфетки (8)</a></li>
                            </ul>
                        </li>
                        <li class="root-item has-child"><a href="#">МАСКИ (15)</a></li>
                        <li class="root-item has-child"><a href="#">СЫВОРОТКИ (12)</a>
                            <ul>
                                <li><a href="#">Тонизирующие средства (3)</a></li>
                                <li><a href="#">Аксессуары для умывания (6)</a></li>
                                <li><a href="#">Матирующие салфетки (8)</a></li>
                        ...
                        <li class="root-item has-child"><a href="#">ТОНИК (6)</a></li>
                        <li class="root-item"><a href="#">НАБОРЫ (17)</a></li>
                    </ul>
                </nav>
                <div id="catalog-filter">
                  <form action="">
                  <div class="item gray cb">
                      <div class="title">Потребности:</div>

                      <ul>
                          <li>
                              <input id="ch1" value="none" type="checkbox"/>
                              <label for="ch1">Жизненная сила (3)</label>
                          </li>
                          <li>
                              <input id="ch2" value="none" type="checkbox"/>
                              <label for="ch2">Под надежной защитой (1)</label>
                          </li>
                          <li>
                              <input id="ch5" value="none" type="checkbox"/>
                              <label for="ch5">Линия роста (8)</label>
                          </li>
                          <li>
                              <input id="ch3" value="none" type="checkbox"/>
                              <label for="ch3">Больше обьема (4)</label>
                          </li>
                          <li>
                              <input id="ch4" value="none" type="checkbox"/>
                              <label for="ch4">Молодость волос (6)</label>
                          </li>
                      </ul>
                      <ul class="cb-hide">
                          <li>
                              <input id="ch6" value="none" type="checkbox"/>
                              <label for="ch6">Больше обьема (4)</label>
                          </li>
                          <li>
                              <input id="ch7" value="none" type="checkbox"/>
                              <label for="ch7">Молодость волос (6)</label>
                          </li>
                      </ul>
                      <div class="control">
                          <a class="btn-cb-show">показать все</a>
                          <a class="btn-cb-hide">скрыть</a>
                  ...
                  <div class="item cb">
                      ...
                      <ul>
                          <li>
                              <input id="ch8" value="none" type="checkbox"/>
                              <label for="ch8">Aloe Rich (6)</label>
                          </li>
                          <li>
                              <input id="ch12" value="none" type="checkbox"/>
                              <label for="ch12">Bio Rehab (4)</label>
                          </li>
                          <li>
                              <input id="ch9" value="none" type="checkbox"/>
                              <label for="ch9">Fruit Energy (7)</label>
                          </li>
                          <li>
                              <input id="ch10" value="none" type="checkbox"/>
                              <label for="ch10">Master Herb (2)</label>
                          </li>
                          <li>
                              <input id="ch14" value="none" type="checkbox"/>
                              <label for="ch14">Королевский Женьшень (10)</label>
                          </li>
                      </ul>
                      <ul class="cb-hide">
                          <li>
                              <input id="ch13" value="none" type="checkbox"/>
                              <label for="ch13">Больше обьема (4)</label>
                          </li>
                          <li>
                              <input id="ch11" value="none" type="checkbox"/>
                              <label for="ch11">Молодость волос (6)</label>
                          </li>
                      </ul>
                      <div class="control">
                          <a class="btn-cb-show">показать все</a>
                  ...
                  <div class="item gray slider">
                      ...
                      <a id="clear1" class="clear" >сбросить</a>

                      <input class="left" type="number" id="n0"/>-<span class="rub">руб.</span>
                      <input class="right" type="number" id="n1"/>
                  ...
                  <div class="item gray slider bally">
                      <div class="title">Цена по баллам</div>
                      <a id="clear2" class="clear">сбросить</a>

                      <input class="left" type="number" id="n2"/>-<span class="rub">Б</span>
                      <input class="right" type="number" id="n3"/>
                  ...
                  <div class="item cb">
                      ...
                      <ul>
                          <li>
                              ...
                              <label for="ch15">Новинки (8)</label>
                          </li>
                          <li>
                              <input id="ch16" type="checkbox"/>
                              <label for="ch16">Акции (4)</label>
                          </li>
                          <li>
                              <input id="ch17" type="checkbox"/>
                              <label for="ch17">Суперцена (10)</label>
                          </li>
                          <li>
                              <input id="ch18" type="checkbox"/>
                              <label for="ch18">Наборы (5)</label>
                          </li>
                          <li>
                              <input id="ch19" type="checkbox"/>
                              <label for="ch19">Подарки (9)</label>
                          </li>
                      </ul>
                      <div class="control">
                          <a class="clear">сбросить</a>
                  ...
                  <div class="item cb">
                      <div class="title">Возрастная категория</div>
                      <ul>
                          <li>
                              <input id="ch20" type="checkbox"/>
                              <label for="ch20">Детям (6)</label>
                          </li>
                          <li>
                              <input id="ch21" type="checkbox"/>
                              <label for="ch21">От 18 до 20 лет (10)</label>
                          </li>
                          <li>
                              <input id="ch22" type="checkbox"/>
                              <label for="ch22">от 20 до 25 (1)</label>
                          </li>
                          <li>
                              <input id="ch23" type="checkbox"/>
                              <label for="ch23">От 25 до 40 лет (5)</label>
                          </li>
                          <li>
                              <input id="ch24" type="checkbox"/>
                              <label for="ch24">От 40 и старше (9)</label>
                          </li>
                      </ul>
                      <div class="control">
                          <a class="clear">сбросить</a>
                ...
                <a class="banner" href="#">
                    <img src="/img/images/catalog-list/banner1.jpg" alt=""/>
                </a>
            </section>
            <!--(/левая колонка)-->
            <div class="clear"></div>
        ...
        <br>
        <h2 class="innertitle">СПЕЦИАЛЬНЫЕ ПРЕДЛОЖЕНИЯ</h2>
        <br>
        <!--(Карусель товаров)-->
    <section id="products-3" class="products">
        ...
        <br>
        <h2 class="innertitle">ВЫ НЕДАВНО СМОТРЕЛИ:</h2>
        <br>

        <!--(Карусель товаров)-->
        <section id="products-4" class="products">
            <section class="swiper-container">
                <div class="arrow-wrapper left"><a href="#" class="arrow arrow-left"></a></div>
                <div class="arrow-wrapper right"><a href="#" class="arrow arrow-right"></a></div>
              <div class="swiper-wrapper">
              ...
              <form action="">
                ...
                <div class="ton">
                          ...
                          <ul class="color">
                              <li class = "white">
                                  <label for="ton11100">
                                      <input type="radio" checked class="not-styler beyond" data-pic="/temp/banner-1.jpg" name="tons3"  id="ton11100">
                              ...
                              <li>
                                  <label for="ton22200">
                                      <input type="radio" class="not-styler beyond" data-pic="/temp/banner-2.jpg" name="tons3"  id="ton22200">
                              ...
                              <li>
                                  <label for="ton33300">
                                      <input type="radio" class="not-styler beyond" data-pic="/temp/banner-3.jpg" name="tons3"  id="ton33300">
                              ...
                              <li>
                                  <label for="ton44400">
                                      <input type="radio" class="not-styler beyond" data-pic="/temp/banner-4.jpg" name="tons3"  id="ton44400">
                              ...
                              <li>
                                  <label for="ton55500">
                                      <input type="radio" class="not-styler beyond" data-pic="/temp/banner-5.jpg" name="tons3"  id="ton55500">
