                                    ...
                                    <div class="down ton">
                                        <div class="prop">
                                            ...
                                            <ul class="color">
                                                <li>
                                                    <label>
                                                        <input type="radio" checked class="not-styler beyond" name="tons11">
                                                ...
                                                <li>
                                                    <label>
                                                        <input type="radio" class="not-styler beyond" name="tons11">
                                    ...
                                    <div class="down ton">
                                        <div class="prop">
                                            ...
                                            <ul class="color">
                                                <li>
                                                    <label>
                                                        <input type="radio" checked class="not-styler beyond" name="tons12">
                                                        <img width="20" height="20" src="/img/tons/ton-1.jpg" alt=""/>
                                                    </label>
                                                    <span class="hint"> 003 </span>
                                                </li>
                                                <li>
                                                    <label>
                                                        <input type="radio" class="not-styler beyond" name="tons12">
                                                        <img width="20" height="20" src="/img/tons/ton-2.jpg" alt=""/>
                                                    </label>
                                                    <span class="hint"> 022 </span>
                                                </li>
                                    ...
                                    <div class="down ton">
                                        <div class="prop">
                                            ...
                                            <ul class="color">
                                                <li>
                                                    <label>
                                                        <input type="radio" checked class="not-styler beyond" name="tons13">
                                                        <img width="20" height="20" src="/img/tons/ton-1.jpg" alt=""/>
                                                    </label>
                                                    <span class="hint"> 003 </span>
                                                </li>
                                                <li>
                                                    <label>
                                                        <input type="radio" class="not-styler beyond" name="tons13">
                                                        <img width="20" height="20" src="/img/tons/ton-2.jpg" alt=""/>
                                                    </label>
                                                    <span class="hint"> 022 </span>
                                                </li>
                                    ...
                                    <div class="down ton">
                                        <div class="prop">
                                            ...
                                            <ul class="color">
                                                <li>
                                                    <label>
                                                        <input type="radio" checked class="not-styler beyond" name="tons14">
                                                        <img width="20" height="20" src="/img/tons/ton-1.jpg" alt=""/>
                                                    </label>
                                                    <span class="hint"> 003 </span>
                                                </li>
                                                <li>
                                                    <label>
                                                        <input type="radio" class="not-styler beyond" name="tons14">
                                                        <img width="20" height="20" src="/img/tons/ton-2.jpg" alt=""/>
                                                    </label>
                                                    <span class="hint"> 022 </span>
                                                </li>
                                    ...
                                    <div class="down ton">
                                        <div class="prop">
                                            ...
                                            <ul class="color">
                                                <li>
                                                    <label>
                                                        <input type="radio" checked class="not-styler beyond" name="tons15">
                                                        <img width="20" height="20" src="/img/tons/ton-1.jpg" alt=""/>
                                                    </label>
                                                    <span class="hint"> 003 </span>
                                                </li>
                                                <li>
                                                    <label>
                                                        <input type="radio" class="not-styler beyond" name="tons15">
                                                        <img width="20" height="20" src="/img/tons/ton-2.jpg" alt=""/>
                                                    </label>
                                                    <span class="hint"> 022 </span>
                                                </li>
