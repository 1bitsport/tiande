        ...
        <section id="two-cols">
            ...
            <section class="col-right">
               <div class="col-content">
                    ...
                    <!--(Главный слайдер)-->
                    <section id="main-slider" class="swiper-container no-js">
                        ...
                        <div class="control">
                            <div class="sort">
                              <form action="">
                                ...
                                <div class="sorter">
                                    <input type="text" value="Рейтингу" class="input-sort drop" name="sort" id="the-sort">
            ...
            <section class="col-left">
                ...
                <div id="catalog-filter">
                  ...
                  <div class="item gray slider">
                      ...
                      <input class="left" type="text" id="n0"/>-<input class="right" type="text" id="n1"/>
                  ...
                  <div class="item gray slider bally">
                      ...
                      <input class="left" type="text" id="n2"/>-<input class="right" type="text" id="n3"/>
                      <span class="rub">Б</span>
                      <div style="clear: both;margin-bottom: 3px;"></div>
                      <div class="lable-left"></div>
                      <div class="lable-right"></div>
                    ...
                    <div class="popup center">
                        <div style="width: 210px;" class="content center popup-text">
                            ...
                            <table class="pp-table">
                                <tbody><tr>
                                    <td>
                                        <div class="orange-icon mini warning-orange"></div>
                                    </td>
                                    <td>
                                        <p class="pp-desc">
                                ...
                                <tr>
                                    <td>
                                        <div class="orange-icon mini new-orange"></div>
                                    </td>
                                    <td>
                                        <p class="pp-desc">
                                ...
                                <tr>
                                    <td>
                                        <div class="orange-icon mini present-orange"></div>
                                    </td>
                                    <td>
                                        <p class="pp-desc">
