		...
		<div class="report-content-in">
			...
			<div class="report-main-filter">
				...
				<div class="additional-filters">
						...
						<div class="inputer">
							<label for="uslovie_lo" class="font14 dark-grey">Условие ЛО OSC:</label>
							<a href="#" class="equality list"><span class="little-arrow"><i></i></span>					
							</a>
							<input type="text" placeholder="Введите значение" class="inputs-focus" name="uslovie_lo" id="uslovie_lo">
							<span href="#" class="posabsolute font10 reset">сбросить</span>
					...
					<table class="report-table font12">
						<thead class="">
							<tr>
								...
								<th width="10%" class="uppercase posrelative font12"><a href="#" class="border-dot-grey">НАЧИСЛЕНО,<br><span style="text-transform:lowercase;">руб</span></a><a class="two-arrows" href="#"><div class="arrow"></div><div class="arrow"></div></a></th>
								...
								<th width="5%" class="uppercase posrelative font12"><a href="#" class="border-dot-grey">УСЛОВИЕ ЛО OSC</a><a class="two-arrows" href="#"><div class="arrow"></div><div class="arrow"></div></a></th>
								...
								<th width="8.4%" class="uppercase posrelative font12"><a href="#" class="border-dot-grey">ФОНД OSC,<br><span style="text-transform:lowercase;">балл</span></a><a class="two-arrows" href="#"><div class="arrow"></div><div class="arrow"></div></a></th>
								<th width="8.4%" class="uppercase posrelative font12"><a href="#" class="border-dot-grey">ФОНД OSC,<br><span style="text-transform:lowercase;">руб</span></a><a class="two-arrows" href="#"><div class="arrow"></div><div class="arrow"></div></a></th>
