			...
			<div class="feedback-inner" >
				...
				<form action="">
					<div class="validator last-step">
						...
						<input type="text" placeholder="E-mail" name="email" class="short form-input importantField itsEmail">
	                    <span class="wrong">Поле не может быть пустым</span>
						<div class="js-select">
	                    ...
	                    <span class="wrong">Выбор темы обязателен</span>
						<div class="cleaner"></div>
						<input type="text" placeholder="Введите заголовок сообщения" name="title" class="mid form-input importantField">
