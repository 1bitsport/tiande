...
<div id="cart-container">
	<form action="">
		<div id="cart-header"><div class="cart-bag-svg"></div><span class="uppercase my-cart">Моя корзина:</span>&nbsp;<span class="cart-font-16">4 позиция(-ии) на сумму 4 520 руб. и на <span class="color-orange">400 Б</span></span></div>
		...
		<div class="cart-summary">
			<div class="cart-summary-left">
				...
				<div class="promo posrelative">
						...
						<input type="submit" class="cart-summary-button button-big-padding button-border" value="Обработать" id="promo_send" name="promo-send">
				...
				<table align="right">
					...
					<tr>
						<td colspan="2" style="text-align: right; padding-top: 10px;">
							<input type="submit" class="cart-summary-button button-small-padding button-border" value="Оформить заказ" name="send-full-form	">
						</td>
					</tr>
				</table>
			</div>
			              ...
			              <a href="#1" class="item has-bonus">
                            ...
                            <div class="description">
                              ...
                              <table>
                                ...
                                <tr>
                                  <td><i>3 007 руб.</i></td>
                                  <td class="cart-bold">15 203 руб.</td>
...
<div id="sost-nabor" class="not-wide" style="display: none; position: relative;">
	<h2>СОСТАВ НАБОРА</h2>
...
<div id="gooddeal" style="display: none; position: relative;">
	...
	<div class="products gooddeal slider"> <!-- Внутри модального окна может быть как слайдер, так и просто несколько элементов (не более 7-ми, иначе становится слайдером. Написан простой скрипт для примера в общем файле скриптов). 
...
<a href="#" class="modal-viewer autoclicker" data-key="#nogooddeal">Клик</a>
<div id="nogooddeal" class="not-wide" style="display:none; position: relative;">
	<p class="uppercase">Акционное предложение по сформированным товарам в корзине отсутсвует</p>	
</div>
<?
