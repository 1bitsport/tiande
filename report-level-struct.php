	...
	<div class="report-content">
		<div class="report-left-menu">
			...
			<div class="report-left-content">
				...
				<ul>
					<li class="selected"><a href="">СТРУКТУРА ПО УРОВНЯМ OSC</a></li>
		...
		<div class="report-content-in">
			<h2>ОТЧЕТ: <a href="">СТРУКТУРА ПО УРОВНЯМ OSC</a></h2>
			<div class="report-main-filter">
				...
				<div class="additional-filters">
						...
						<div class="inputer">
							<label for="bonusball" class="font14 dark-grey">Кол-во Дистрибьюторов:</label>
				...
				<div class="main-table">
					<table class="report-table font12">
						<thead class="">
							<tr>
								<th width="20%" class="uppercase posrelative font12 "><a href="#" class="border-dot-grey">Уровень</a><a class="down-arrow" href="#"><div class="arrow"></div><div class="arrow"></div></a></th>
								<th width="30%" class="uppercase posrelative font12"><a href="#" class="border-dot-grey">Кол-во дистрибьюторов на уровне</a><a class="two-arrows" href="#"><div class="arrow"></div><div class="arrow"></div></a></th>
								<th width="30%" class="uppercase posrelative font12"><a href="#" class="border-dot-grey">Объем уровня,<br><span style="text-transform:lowercase;">балл</span></a><a class="two-arrows" href="#"><div class="arrow"></div><div class="arrow"></div></a></th>
								<th width="20%" class="uppercase posrelative font12"><a href="#" class="border-dot-grey">Детали</a><a class="two-arrows" href="#"><div class="arrow"></div><div class="arrow"></div></a></th>
							</tr>
						</thead>
						<tbody>
							<tr>
								...
								<td>41</td>
								<td>100</td>
								<td><a href="#" class="detailed modal-viewer table-hit" data-key="#struct-modal"><img src="/img/lupa.gif" alt=""></a></td>
							</tr>
