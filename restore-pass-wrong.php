	...
	<form class="restore-password">
		<ul class="general-restore">
			<li class="restore-step first active">
				...
				<div class="form-content one active marginer wrong">
					...
					<span class="wrong posabsolute">Анкеты с таким номером не существует</span>
			...
			<li class="restore-step third">
				...
				<div class="form-content email hide marginer wrong">
					...
					<span class="wrong posabsolute">e-mail не введен</span>
					<a href="#next" class="continue active uppercase">Восстановить</a>
				</div>

				<div class="form-content eiac hide marginer wrong">
					...
					<span class="wrong posabsolute">В этом поле должен быть комментарий</span>
					...
					<span class="wrong posabsolute">Укажите путь к скану страницы Вашего паспорта</span>
					<a href="#next" class="continue active uppercase">Восстановить</a>
