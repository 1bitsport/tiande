					...
					<table class="report-table font12">
						<thead class="">
							<tr>
								...
								<th width="14%" class="uppercase posrelative font12"><a href="#" class="border-dot-grey">ФИО</a><a class="two-arrows" href="#"><div class="arrow"></div><div class="arrow"></div></a></th>
								<th width="12%" class="uppercase posrelative font12"><a href="#" class="border-dot-grey">Номер cпонсора</a><a class="two-arrows" href="#"><div class="arrow"></div><div class="arrow"></div></a></th>
								<th width="11%" class="uppercase posrelative font12"><a href="#" class="border-dot-grey">Спонсор</a><a class="two-arrows" href="#"><div class="arrow"></div><div class="arrow"></div></a></th>
								<th width="11%" class="uppercase posrelative font12"><a href="#" class="border-dot-grey">Заказы,<br><span style="text-transform:lowercase;">балл</span></a><a class="two-arrows" href="#"><div class="arrow"></div><div class="arrow"></div></a></th>
								<th width="6%" class="uppercase posrelative font12"><a href="#" class="border-dot-grey">%</a><a class="two-arrows" href="#"><div class="arrow"></div><div class="arrow"></div></a></th>
								<th width="10%" class="uppercase posrelative font12 gudini"><a href="#" class="border-dot-grey">Расчёт</a><a class="two-arrows" href="#"><div class="arrow"></div><div class="arrow"></div></a></th>
								<th width="11%" class="uppercase posrelative font12"><a href="#" class="border-dot-grey">Бонус,<br><span style="text-transform:lowercase;">балл</span></a><a class="two-arrows" href="#"><div class="arrow"></div><div class="arrow"></div></a></th>
								<th width="11%" class="uppercase posrelative font12"><a href="#" class="border-dot-grey">Бонус,<br><span style="text-transform:lowercase;">руб</span></a><a class="two-arrows" href="#"><div class="arrow"></div><div class="arrow"></div></a></th>
							</tr>
						</thead>
						<tbody>
							<tr>
