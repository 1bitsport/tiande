	...
	<div class="report-content">
		...
		<div class="report-content-in">
			...
			<div class="report-main-filter">
				...
				<a href="#" class="green-btn uppercase">Показать</a><a href="#" class="this-btn printer uppercase">Распечатать</a>
				...
				<div class="main-table">
					<table class="report-table font12">
						<thead class="">
							<tr>
								<th width="30%" class="uppercase posrelative font12"><span>АДРЕС РЕФЕРАЛЬНОЙ ССЫЛКИ</span></th>
								<!-- <th width="28%" class="uppercase posrelative font12"><span>АДРЕС ПЕРЕХОДА</span></th> -->
								<th width="14%" class="uppercase posrelative font12"><a href="#" class="border-dot-grey">ДАТА</a><img src="img/table-arrows.png" alt=""></th>
								<th width="14%" class="uppercase posrelative font12"><a href="#" class="border-dot-grey">КОЛ-ВО ПЕРЕХОДОВ</a><img src="img/table-arrows.png" alt=""></th>
								<th width="14%" class="uppercase posrelative font12"><a href="#" class="border-dot-grey">КОЛ-ВО РЕГИСТРАЦИЙ</a><img src="img/table-arrows.png" alt=""></th>
								<th width="14%" class="uppercase posrelative font12"><a href="#" class="border-dot-grey">КОЛ-ВО ЗАКАЗОВ</a><img src="img/table-arrows.png" alt=""></th>
								<th width="14%" class="uppercase posrelative font12"><a href="#" class="border-dot-grey">ЗАКАЗЫ,<br><span style="text-transform:lowercase;">балл</span></a><img src="img/table-arrows.png" alt=""></th>
							</tr>
						</thead>
						<tbody>
							<tr>								
									...
									<div class="has-popup has-icon ref">
								        ...
								        <div class="popup center" id="partnership2">
								          <div class="content">
								            ...
								            <div class="social inside share-content share-content-slide" >
...
<div id="refer-change" class="modal not-wide" style="display: none; position: relative;">
