...
<div class="reports-page my-orders order stages">
	...
	<div class="stages-content">
      ...
      <h3 class="slide-up slide-content-h">
        <span class="h3">Местоположение посылки</span>
        <span class="slider-arrow"></span>
      </h3>

      <div class="post-tracker">
        <h4>Отслеживание посылки</h4>
        <div class="post-tracker-inner">
        
          <div class="top">
            <p>Номер почтового отправления № 9 999 999</p>
            <img src="/img/rus_post.jpg" alt="">
          </div>
          <div class="bottom">
            <p>Местоположение посылки можно посмотреть на официальном сайте 
              <a href="http://russianpost.ru/">russianpost.ru</a>, указав в строке поиска № почтового отправления</p>
              <p class="left_p">Способ отправления: Почта России</p>
          </div>
