...
?>
<div class="reports-page my-orders">
				...
				<div id="catalog-filter">
					<form action="">
	                    <div class="item gray cb">
	                        <div class="title">СТАТУСЫ ЗАКАЗОВ</div>
	                        <ul>
	                            <li>
	                                <input id="now_orders" name="order_status" value="Y" type="radio"/>
	                                <label for="now_orders">ТЕКУЩИЕ</label>
	                            </li>
	                            <li>
	                                <input id="done_orders" name="order_status" value="Y" type="radio"/>
	                                <label for="done_orders">ЗАВЕРШЕННЫЕ</label>
	                            </li>
	                            <li>
	                                <input id="not_buyed" name="order_status" value="Y" type="radio"/>
	                                <label for="not_buyed">НЕВЫКУПЛЕННЫЕ</label>
	                            </li>
	                        </ul>  
	                    </div>
	                    <div class="item gray cb">
					...
					<table class="report-table">
						<thead class="">
							<tr>
								...
								<th width="10%" class="uppercase posrelative font12"><a href="#" class="border-dot-grey">В резерве до</a><a class="two-arrows" href="#"><div class="arrow"></div><div class="arrow"></div></a></th>
								<th width="10%" class="uppercase posrelative font12"><a href="#" class="border-dot-grey">№ Заказа</a><a class="two-arrows" href="#"><div class="arrow"></div><div class="arrow"></div></a></th>
								<th width="11%" class="uppercase posrelative font12"><a href="#" class="border-dot-grey">Сумма</a><a class="two-arrows" href="#"><div class="arrow"></div><div class="arrow"></div></a></th>
								<th width="10%" class="uppercase posrelative font12"><a href="#" class="border-dot-grey">Сумма балл</a><a class="two-arrows" href="#"><div class="arrow"></div><div class="arrow"></div></a></th>
								<th width="18%" class="uppercase posrelative font12"><a href="#" class="border-dot-grey">Получение</a></th>
								<th width="10%" class="uppercase posrelative font12"><a href="#" class="border-dot-grey">Статус</a><a class="two-arrows" href="#"><div class="arrow"></div><div class="arrow"></div></a></th>
								<th width="20%" class="uppercase posrelative font12 gudini"><a href="#" class="border-dot-grey">Действие</a><a class="two-arrows" href="#"><div class="arrow"></div><div class="arrow"></div></a></th>
							</tr>
						</thead>
						<tbody>
							<tr>
								...
								<td><span class="wait_yellow bold">ОЖИДАЕТ ОТГРУЗКИ</span></td>
							...
							<tr>
								...
								<td><span class="done_green bold">ГОТОВ</span></td>
								<td><a href="#" class="green-btn">ОПЛАТИТЬ</a></td>
							</tr>
