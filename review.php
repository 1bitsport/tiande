		...
		<div class="right-content">
			<div class="content-inner">
				...
				<form action="review-final.php">
					...
					<textarea name="comment" id="" cols="30" rows="10" class="form-input" placeholder="Комментарий"></textarea>
					<input type="submit" value="ОСТАВИТЬ ОТЗЫВ" class="green-btn continue">
				</form>
			</div>
		</div>
	</div>
