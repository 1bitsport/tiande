			...
			<form>
				...
				<div class="report-main-filter">
					...
					<ul class="report-main-filter-additional">                
						<li>
							<input id="cfirst" type="radio" name="struct" hidden />
							<label for="cfirst">Показать структуру деревом</label>
						</li>
						<li>
							<input id="csecond" type="radio" name="struct" hidden />
							<label for="csecond">Показать только новых Дистрибьюторов</label>
						</li>
						<li>
							<input id="cthird" type="radio" name="struct" hidden />
				...
				<div class="additional-filters">
						...
						<div class="inputer hide_element">
							<label for="" class="font14 dark-grey">Спонсор:</label>
							<input type="text" placeholder="Введите значение" class="inputs-focus" name="" id="">
							<span href="#" class="posabsolute font10 reset">сбросить</span>
						</div>
				...
				<div class="main-table">
					<table class="report-table font12">
						<thead class="">
							<tr>
								<th width="1%" class="uppercase posrelative font12 "><a href="#" class="center"><img src="img/black-distr.png" alt=""></a><a class="down-arrow" href="#"><div class="arrow"></div><div class="arrow"></div></a></th>
								<th width="7%" class="uppercase posrelative font12"><a href="#" class="border-dot-grey">Уровень</a><a class="two-arrows" href="#"><div class="arrow"></div><div class="arrow"></div></a></th>
								<th width="8%" class="uppercase posrelative font12"><a href="#" class="border-dot-grey">Номер анкеты</a><a class="two-arrows" href="#"><div class="arrow"></div><div class="arrow"></div></a></th>
								<th width="10%" class="uppercase posrelative font12"><a href="#" class="border-dot-grey">ФИО</a><a class="two-arrows" href="#"><div class="arrow"></div><div class="arrow"></div></a></th>
								<th width="13%" class="uppercase posrelative font12"><a href="#" class="border-dot-grey">Статус OSC</a><a class="two-arrows" href="#"><div class="arrow"></div><div class="arrow"></div></a></th>
								<th width="5%" class="uppercase posrelative font12"><a href="#" class="border-dot-grey">!</a><a class="two-arrows" href="#"><div class="arrow"></div><div class="arrow"></div></a></th>
								<th width="8%" class="uppercase posrelative font12"><a href="#" class="border-dot-grey">Номер спонсора</a><a class="two-arrows" href="#"><div class="arrow"></div><div class="arrow"></div></a></th>
								<th width="8%" class="uppercase posrelative font12 gudini"><a href="#" class="border-dot-grey">Спонсор</a><a class="two-arrows" href="#"><div class="arrow"></div><div class="arrow"></div></a></th>
								<th width="8.4%" class="uppercase posrelative font12"><a href="#" class="border-dot-grey">ЛО OSC,<br><span style="text-transform:lowercase;">балл</span></a><a class="two-arrows" href="#"><div class="arrow"></div><div class="arrow"></div></a></th>
								<th width="8.4%" class="uppercase posrelative font12"><a href="#" class="border-dot-grey">СО OSC,<br><span style="text-transform:lowercase;">балл</span></a><a class="two-arrows" href="#"><div class="arrow"></div><div class="arrow"></div></a></th>
								<th width="8.4%" class="uppercase posrelative font12"><a href="#" class="border-dot-grey">Неоплач. ЛО OSC,<br><span style="text-transform:lowercase;">балл</span></a><a class="two-arrows" href="#"><div class="arrow"></div><div class="arrow"></div></a></th>
